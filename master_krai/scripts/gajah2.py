...
class mekanisme_gajah():
	...
	sudut = rospy.get_param("/Mekanisme/sudut")	
	...
	def pub_mechanism(self):		
		...
		self.mechanism.y_penembak = self.vertical			
	...
	def Command_cb(self, msg):
		...
		#---------------------arah shooter-----------------------#		
		if msg.buttons[13] == 1: self.horizontal = 120	#kanan			
		if msg.buttons[14] == 1: self.horizontal = -120	#kiri
		...
		#--------------------shoot on mode--------------------------#
			...
			self.vertical = self.sudut[self.i - 1]
